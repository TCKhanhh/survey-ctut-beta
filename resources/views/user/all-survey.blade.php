                                        ...
                                        <form>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    ...
                                                    <label class="custom-control-label" for="q1a">Rất đầy đủ và hữu
                                                        ích</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q2a">
                                                    <label class="custom-control-label" for="q2a">Điểm chuẩn các
                                                        năm</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q2b">
                                                    <label class="custom-control-label" for="q2b">Chương trình đào
                                                        tạo</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q2c">
                                                    <label class="custom-control-label" for="q2c">Cơ hội việc
                                                        làm</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q2d">
                                                    <label class="custom-control-label" for="q2d">Học phí và học
                                                        bổng</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q2e">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="q6b" name="question6"
                                                        class="custom-control-input">
                                                    <label class="custom-control-label" for="q6b">Quan tâm</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="q5b" name="question5"
                                                        class="custom-control-input">
                                                    <label class="custom-control-label" for="q5b">Hài lòng</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="q8a" name="question8"
                                                        class="custom-control-input">
                                                    <label class="custom-control-label" for="q8a">Không có khó khăn
                                                        gì</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" id="q8b" name="question8"
                                                        class="custom-control-input">
                                                    <label class="custom-control-label" for="q8b">Thông tin chưa rõ
                                                        ràng</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q9a">
                                                    <label class="custom-control-label" for="q9a">Chất lượng đào tạo
                                                        tốt</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q9b">
                                                    <label class="custom-control-label" for="q9b">Cơ hội thực
                                                        tập/việc làm</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q9c">
                                                    <label class="custom-control-label" for="q9c">Môi trường học tập
                                                        năng động</label>
                                                </div>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="q9d">
