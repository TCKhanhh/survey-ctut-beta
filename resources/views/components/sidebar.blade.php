<aside class="main-sidebar sidebar-dark-primary elevation-0 fixed-top"
    ...
    <!-- Brand Logo -->
    <a href="{{ route('viewHome') }}" class="brand-link ajax-link">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('viewHome') }}" class="nav-link ajax-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('viewAllSurvey') }}" class="nav-link ajax-link">
                                <i class="far fa-file-alt nav-icon"></i>
                                <p>Tất cả khảo sát</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('viewAdmissionSupport') }}" class="nav-link ajax-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('viewSurveyUnderway') }}" class="nav-link ajax-link">
                                <i class="far fa-play-circle nav-icon"></i>
                                <p>Khảo sát đang thực hiện</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('viewSurveyHistory') }}" class="nav-link ajax-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('viewStatisticalResult') }}" class="nav-link ajax-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('viewEventNotification') }}" class="nav-link ajax-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('viewInstructionalSupport') }}" class="nav-link ajax-link">
                ...
                <li class="nav-item">
                    <a href="{{ route('viewAccountSetting') }}" class="nav-link ajax-link">
