<nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm fixed-top">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a href="{{ route('viewHomeAdmin') }}" class="nav-link">Trang chủ</a>
        </li>
        <li class="nav-item">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                ...
                {{-- <a href="{{ route('processLogoutAdmin') }}" onclick="userLogout_admin()" class="dropdown-item"
                    style="cursor: pointer;">
                    <i class="fa-solid fa-right-to-bracket mr-2"></i>Đăng xuất
                </a> --}}

                <form action="{{ route('processLogoutAdmin') }}" method="POST" id="logout-form">
                    @csrf
